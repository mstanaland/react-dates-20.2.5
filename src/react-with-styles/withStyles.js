...
function withStyles(styleFn) {
  var _ref =
    ...
    stylesPropName =
      _ref$stylesPropName === undefined ? "styles" : _ref$stylesPropName,
    _ref$themePropName = _ref.themePropName,
    themePropName =
      _ref$themePropName === undefined ? "theme" : _ref$themePropName,
    ...
    pureComponent =
      _ref$pureComponent === undefined ? false : _ref$pureComponent;
  ...
  function getResolveMethod(direction) {
    return direction === _constants.DIRECTIONS.LTR
      ? _ThemedStyleSheet2["default"].resolveLTR
      : _ThemedStyleSheet2["default"].resolveRTL;
  }
  ...
  function getStyleDef(direction, wrappedComponentName) {
    ...
    var styleDef =
      direction === _constants.DIRECTIONS.LTR ? styleDefLTR : styleDefRTL;
    ...
    if (isRTL) {
      styleDefRTL = styleFn
        ? _ThemedStyleSheet2["default"].createRTL(styleFn)
        : EMPTY_STYLES_FN;
      ...
      styleDefLTR = styleFn
        ? _ThemedStyleSheet2["default"].createLTR(styleFn)
        : EMPTY_STYLES_FN;
  ...
  return (function () {
    function withStylesHOC(WrappedComponent) {
      ...
      var WithStyles = (function (_BaseClass) {
        ...
        function WithStyles(props, context) {
          ...
          var _this = _possibleConstructorReturn(
            this,
            (WithStyles.__proto__ || Object.getPrototypeOf(WithStyles)).call(
              this,
              props,
              context
            )
          ...
          var direction = _this.context[_constants.CHANNEL]
            ? _this.context[_constants.CHANNEL].getState()
            : defaultDirection;
                ...
                return _react2["default"].createElement(
                  ...
                  _extends(
                    ...
                    _defineProperty(
                      _ref2,
                      themePropName,
                      _ThemedStyleSheet2["default"].get()
                    ),
                    _defineProperty(_ref2, stylesPropName, styleDef()),
                    _defineProperty(_ref2, cssPropName, resolveMethod),
                    _ref2)
                  )
                );
              }
      ...
      WithStyles.displayName =
        "withStyles(" + String(wrappedComponentName) + ")";
      WithStyles.contextTypes = contextTypes;
      if (WrappedComponent.propTypes) {
        WithStyles.propTypes = (0, _object2["default"])(
          {},
      ...
      if (WrappedComponent.defaultProps) {
        WithStyles.defaultProps = (0, _object2["default"])(
          {},
